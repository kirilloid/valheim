...
// MEADOWS
  ...
  { type: 'item', id: 'Flint', tier: 1, weight: 2, stack: 30,
    recipe: { locations: ['Meadows', 'BlackForest'], abundance: 1, num: [30, 30], group: [1, 1], respawn: 4 * HOUR } },
  ...
  { type: 'food', id: 'Raspberry', emoji: '🍓', tier: 1, weight: 0.1, stack: 50,
    ...
    recipe: { locations: ['Meadows'], abundance: 1, num: [1, 1], group: [3, 8], inForest: [1, 1.2], respawn: 5 * HOUR } },
  { type: 'food', id: 'Mushroom', emoji: '🍄🔴', tier: 1, weight: 0.1, stack: 50,
    health: 15, stamina: 20, duration: 600, regen: 1, color: '#ff7353ff',
    recipe: { locations: ['Meadows', 'BlackForest', /* 'Swamp', yes but minAlt=1 */], abundance: 1, num: [1, 2], group: [3, 6], inForest: [0, 1], respawn: 4 * HOUR } },
  { type: 'item', id: 'Dandelion', tier: 0, weight: 0.1, stack: 50,
    recipe: { locations: ['Meadows'], abundance: 1, num: [8, 10], group: [1, 3], respawn: 4 * HOUR } },
  { type: 'food', id: 'Honey', emoji: '🍯', tier: 1, weight: 0.2, stack: 50,
    health: 20, stamina: 20, duration: 300, regen: 5, color: '#ffae00ff',
    recipe: { time: GAME_DAY, materials: {}, source: { station: CraftingStation.BeeHive }, number: 1 } },
...
// BLACK FOREST
  ...
  { type: 'item', id: 'SurtlingCore', emoji: '🟥', tier: 2, weight: 5, stack: 10,
    recipe: { locations: ['BurialChamber'], abundance: 1, num: [2, 5], group: [2, 3], respawn: 0 } },
  ...
  { type: 'food', id: 'Blueberries', emoji: '🫐', tier: 2, weight: 0.1, stack: 50,
    ...
    recipe: { locations: ['BlackForest'], abundance: 1, num: [1, 2], group: [2, 3], respawn: 5 * HOUR } },
  ...
  { type: 'food', id: 'MushroomYellow', emoji: '🍄🟡', tier: 2, weight: 0.1, stack: 50,
    ...
    recipe: { locations: ['BlackForest', 'Swamp'], abundance: 1,
  ...
  { type: 'item', id: 'Thistle', emoji: '🌿', tier: 2, weight: 0.1, stack: 50,
    recipe: { locations: ['BlackForest', 'Swamp'], abundance: 1, num: [1, 2], group: [2, 5], respawn: 4 * HOUR } },
  { type: 'item', id: 'CarrotSeeds', tier: 2, weight: 0.1, stack: 100,
    recipe: { locations: ['BlackForest'], abundance: 1, num: [0, 0.5], group: [1, 2], respawn: 0 } },
  ...
  { type: 'item', id: 'TurnipSeeds', tier: 3, weight: 0.1, stack: 100,
    recipe: { locations: ['Swamp'], abundance: 1, num: [0, 0.5], group: [1, 2], respawn: 0 } },
...
// MOUNTAIN
  ...
  { type: 'item', id: 'DragonEgg', emoji: '🥚', tier: 4, weight: 200, stack: 1,
    ...
    recipe: { locations: ['Mountain'], abundance: 1, num: [1, 1], group: [1, 1], respawn: 6 * HOUR } },
...
// PLAINS
  ...
  { type: 'food', id: 'Cloudberry', emoji: '🟠', tier: 5, weight: 0.1, stack: 50,
    ...
    recipe: { locations: ['Plains'], abundance: 1, num: [1, 3], group: [15, 20], respawn: 5 * HOUR } },
