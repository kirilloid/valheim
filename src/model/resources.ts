...
// MEADOWS
  { type: 'item', id: 'Wood', emoji: '🪵', tier: 0, weight: 2, stack: 50 },
  ...
  { type: 'potion', id: 'MeadHealthMinor', emoji: '\u{1F9EA}', tier: 1, weight: 1, stack: 10,
    ...
    recipe: { time: FERMENT_TIME, materials: { Honey: 10, Blueberries: 5, Raspberries: 10, Dandelion: 1 },
  ...
  { type: 'potion', id: 'MeadStaminaMinor', emoji: '\u{1F9EA}', tier: 1, weight: 1, stack: 10,
    ...
    recipe: { time: FERMENT_TIME, materials: { Honey: 10, Raspberries: 10, MushroomYellow: 10 },
              source: { station: CraftingStation.Fermenter }, number: 6 } },
  { type: 'potion', id: 'MeadTasty', emoji: '\u{1F9EA}', tier: 1, weight: 1, stack: 10,
    staminaRegen: 4, healthRegen: 0.5, cooldown: 120, 
    recipe: { time: FERMENT_TIME, materials: { Honey: 10, Blueberries: 5, Raspberries: 10 },
              source: { station: CraftingStation.Fermenter }, number: 6 } },
  ...
  { type: 'item', id: 'TrophyEikthyr', emoji: '🦌', tier: 2, weight: 2, stack: 20, power: 'Eikthyr' },
...
// BLACK FOREST
  ...
  { type: 'potion', id: 'MeadHealthMedium', emoji: '\u{1F9EA}', tier: 1, weight: 1, stack: 10,
    ...
    recipe: { time: FERMENT_TIME, materials: { Honey: 10, Bloodbag: 4, Raspberries: 10, Dandelion: 1 },
              source: { station: CraftingStation.Fermenter }, number: 6 } },
  ...
  { type: 'item', id: 'TrophyTheElder', tier: 3, weight: 4, stack: 20, power: 'gd_king' },
  { type: 'item', id: 'CryptKey', emoji: '🗝️', tier: 3, weight: 0.1, stack: 1 },
// SWAMP
  ...
  { type: 'potion', id: 'MeadFrostResist', emoji: '\u{1F9EA}', tier: 1, weight: 1, stack: 10,
    ...
    recipe: { time: FERMENT_TIME, materials: { Honey: 10, Thistle: 5, Coal: 10, NeckTail: 1 },
              source: { station: CraftingStation.Fermenter }, number: 6 } },
  { type: 'item', id: 'ElderBark', tier: 3, weight: 2, stack: 50 },
  ...
  { type: 'item', id: 'WitheredBone', emoji: '🦴', tier: 3, weight: 1, stack: 30, summon: 'Bonemass' },
  ...
  { type: 'item', id: 'TrophyBonemass', emoji: '🦠', tier: 4, weight: 2, stack: 20, power: 'Bonemass' },
// OCEAN
  { type: 'item', id: 'Chitin', tier: 4, weight: 2, stack: 50 },
  { type: 'item', id: 'SerpentScale', tier: 4, weight: 2, stack: 50 },
  { type: 'item', id: 'SerpentMeat', tier: 4, weight: 10, stack: 50 },
...
// MOUNTAIN
  ...
  { type: 'item', id: 'TrophyDragonQueen', tier: 5, weight: 2, stack: 20, power: 'DragonQueen' },
  { type: 'item', id: 'DragonTear', tier: 5, weight: 1, stack: 50 },
// PLAINS
  ...
  { type: 'item', id: 'TrophyGoblinKing', tier: 5, weight: 1, stack: 20, power: 'GoblinKing' },
  { type: 'item', id: 'Yagluththing', tier: 5, weight: 0.1, stack: 1 },
// FLAME
