...
// MEADOWS
  ...
  { type: 'item', id: 'Flint', tier: 1, weight: 2, stack: 30,
    grow: { locations: ['Meadows', 'BlackForest'],
  ...
  { type: 'food', id: 'Raspberry', emoji: '🍓', tier: 1, weight: 0.1, stack: 50, tags: ['plant'],
    ...
    grow: { locations: ['Meadows'], abundance: 1, num: [1, 1], group: [3, 8], inForest: [1, 1.2], respawn: 5 * HOUR } },
  { type: 'food', id: 'Mushroom', emoji: '🍄🔴', tier: 1, weight: 0.1, stack: 50,
    health: 15, stamina: 20, duration: 600, regen: 1, color: '#ff7353ff',
    grow: { locations: ['Meadows', 'BlackForest', /* 'Swamp', yes but minAlt=1 */],
  ...
  { type: 'item', id: 'Dandelion', tier: 0, weight: 0.1, stack: 50, tags: ['plant', 'herb'],
    grow: { locations: ['Meadows'], abundance: 1, num: [8, 10], group: [1, 3], respawn: 4 * HOUR } },
...
// BLACK FOREST
  ...
  { type: 'item', id: 'SurtlingCore', emoji: '🟥', tier: 2, weight: 5, stack: 10,
    grow: { locations: ['Crypt'], abundance: 1, num: [2, 5], group: [2, 3], respawn: 0 } },
  ...
  { type: 'food', id: 'Blueberries', emoji: '🫐', tier: 2, weight: 0.1, stack: 50, tags: ['plant'],
    ...
    grow: { locations: ['BlackForest'], abundance: 1, num: [1, 2], group: [2, 3], respawn: 5 * HOUR } },
  ...
  { type: 'food', id: 'MushroomYellow', emoji: '🍄🟡', tier: 2, weight: 0.1, stack: 50,
    ...
    grow: { locations: ['TrollCave', 'Crypt', 'SunkenCrypt'], abundance: 1,
...
/*  { type: 'food', id: 'MushroomBlue', emoji: '🍄🔵', tier: 2, weight: 0.1, stack: 50,
  ...
  { type: 'item', id: 'Thistle', emoji: '🌿', tier: 2, weight: 0.1, stack: 50, tags: ['plant', 'herb'],
    grow: { locations: ['BlackForest', 'Swamp'], abundance: 1, num: [1, 2], group: [2, 5], respawn: 4 * HOUR } },
  { type: 'item', id: 'CarrotSeeds', tier: 2, weight: 0.1, stack: 100,
    grow: { locations: ['BlackForest'], abundance: 1, num: [0, 0.5], group: [1, 2], respawn: 0 } },
  ...
  { type: 'item', id: 'TurnipSeeds', tier: 3, weight: 0.1, stack: 100,
    grow: { locations: ['Swamp'], abundance: 1, num: [0, 0.5], group: [1, 2], respawn: 0 } },
...
// MOUNTAIN
  ...
  { type: 'item', id: 'DragonEgg', emoji: '🥚', tier: 4, weight: 200, stack: 1,
    ...
    grow: { locations: ['DrakeNest'], abundance: 1, num: [1, 1], group: [1, 1], respawn: 0 /*6 * HOUR*/ } },
...
// PLAINS
  ...
  { type: 'food', id: 'Cloudberry', emoji: '🟠', tier: 5, weight: 0.1, stack: 50, tags: ['plant'],
    ...
    grow: { locations: ['Plains'], abundance: 1, num: [1, 3], group: [15, 20], respawn: 5 * HOUR } },
