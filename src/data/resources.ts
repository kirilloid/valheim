...
/*  { type: 'food', id: 'MushroomBlue', emoji: '🍄🔵', tier: 2, weight: 0.1, stack: 50,
  ...
  { type: 'food', id: 'DeerStew', emoji: '🍲', tier: 2, weight: 1, stack: 20,
  ...
  { type: 'food', id: 'MinceMeatSauce', emoji: '', tier: 2, weight: 1, stack: 20,
...
// MOUNTAIN
  ...
  { type: 'food', id: 'CookedWolfMeat', emoji: '', tier: 4, weight: 1, stack: 20,
    health: 45, stamina: 9, duration: 1200, regen: 3, color: '#973C3AFF',
  ...
  { type: 'food', id: 'WolfJerky', emoji: '', tier: 4, weight: 1, stack: 20,
...
/*    recipe: { type: 'craft_one', time: 4500, materials: { Barley: 1 },
  ...
  { type: 'item', id: 'LoxPieUncooked', emoji: '', tier: 5, weight: 0.5, stack: 20,
