...
// BLACK FOREST
  ...
  { type: 'item', id: 'MeadBaseHasty', iconId: 'resource/MeadBase', tier: 1, weight: 1, stack: 1 },
  { type: 'item', id: 'MeadHasty', emoji: '\u{1F9EA}', tier: 1, weight: 1, stack: 10,
    effect: effectsById.Potion_hasty,
  },
  { type: 'item', id: 'MeadBaseBzerker', iconId: 'resource/MeadBase', tier: 1, weight: 1, stack: 1 },
  { type: 'item', id: 'MeadBzerker', emoji: '\u{1F9EA}', tier: 1, weight: 1, stack: 10,
    effect: effectsById.Potion_Bzerker,
  },
  { type: 'item', id: 'MeadBaseStrength', iconId: 'resource/MeadBase', tier: 1, weight: 1, stack: 1 },
  { type: 'item', id: 'MeadStrength', emoji: '\u{1F9EA}', tier: 1, weight: 1, stack: 10,
    effect: effectsById.Potion_strength,
  },
  { type: 'item', id: 'MeadBaseLightfoot', iconId: 'resource/MeadBase', tier: 1, weight: 1, stack: 1 },
  { type: 'item', id: 'MeadLightfoot', emoji: '\u{1F9EA}', tier: 1, weight: 1, stack: 10,
    effect: effectsById.Potion_LightFoot,
  },
  { type: 'item', id: 'MeadBaseSwimmer', iconId: 'resource/MeadBase', tier: 1, weight: 1, stack: 1 },
  { type: 'item', id: 'MeadSwimmer', emoji: '\u{1F9EA}', tier: 1, weight: 1, stack: 10,
    effect: effectsById.Potion_swimmer,
  },
  { type: 'item', id: 'MeadBaseTamer', iconId: 'resource/MeadBase', tier: 1, weight: 1, stack: 1 },
  { type: 'item', id: 'MeadTamer', emoji: '\u{1F9EA}', tier: 1, weight: 1, stack: 10,
    effect: effectsById.Potion_tamer,
  },
  { type: 'item', id: 'MeadBaseBugRepellent', iconId: 'resource/MeadBase', tier: 1, weight: 1, stack: 1 },
  { type: 'item', id: 'MeadBugRepellent', emoji: '\u{1F9EA}', tier: 1, weight: 1, stack: 10,
...
// MISTLANDS
  ...
  { type: 'item', id: 'FeastMistlands', emoji: '🥙', tier: 6, weight: 1, stack: 1,
    Food: { health: 65, stamina: 65, eitr: 33, duration: 3000, regen: 4 },
  },
...
// ASHLANDS
  ...
  { type: 'item', id: 'MeadBaseEitrLingering', iconId: 'resource/MeadBase', tier: 1, weight: 1, stack: 1 },
  { type: 'item', id: 'MeadEitrLingering', emoji: '\u{1F9EA}', tier: 1, weight: 1, stack: 10,
    Potion: { eitrRegen: 1.25, cooldown: 300 },
  },
  { type: 'item', id: 'MeadBaseHealthLingering', iconId: 'resource/MeadBase', tier: 1, weight: 1, stack: 1 },
  { type: 'item', id: 'MeadHealthLingering', emoji: '\u{1F9EA}', tier: 1, weight: 1, stack: 10,
