...
// MEADOWS
  ...
  { type: 'food', group: 'berry', id: 'Raspberry', emoji: '🍓', tier: 1, weight: 0.1, stack: 50, tags: ['plant'],
    health: 7, stamina: 20, duration: 600, regen: 1, color: '#ff7a7aff',
  ...
  { type: 'food', id: 'Mushroom', emoji: '🍄🔴', tier: 1, weight: 0.1, stack: 50,
    health: 15, stamina: 15, duration: 900, regen: 1, color: '#ff7353ff',
    grow: itemGrow({
  ...
  { type: 'food', id: 'Honey', emoji: '🍯', tier: 1, weight: 0.2, stack: 50,
    health: 8, stamina: 35, duration: 900, regen: 1, color: '#ffae00ff',
  ...
  { type: 'food', id: 'CookedMeat', emoji: '🍗', tier: 1, weight: 1, stack: 20,
    health: 30, stamina: 10, duration: 1200, regen: 2, color: '#ab7862ff',
    recipe: { type: 'craft_one', time: 25, materials: { RawMeat: 1 },
              source: { station: CraftingStation.CookingStation }, number: 1 },
  },
  { type: 'food', id: 'BoarJerky', emoji: '🥓', tier: 1, weight: 0.5, stack: 20,
    health: 20, stamina: 20, duration: 1800, regen: 1, color: '#9E5E35ff',
  ...
  { type: 'food', id: 'NeckTailGrilled', emoji: '🥓', tier: 1, weight: 0.5, stack: 20,
    health: 25, stamina: 8, duration: 1200, regen: 2, color: '#c59645ff',
    recipe: { type: 'craft_one', time: 25, materials: { NeckTail: 1 },
              source: { station: CraftingStation.CookingStation }, number: 1 },
  },
  { type: 'item', id: 'FishRaw', emoji: '🐟', tier: 2, weight: 0.5, stack: 20 },
  { type: 'food', id: 'FishCooked', emoji: '🍣', tier: 2, weight: 0.5, stack: 20,
    health: 45, stamina: 15, duration: 1200, regen: 2, color: '#ce8550ff',
...
// BLACK FOREST
  { type: 'item', group: 'seed', id: 'Acorn', tier: 2, weight: 0.1, stack: 100, floating: true },
  { type: 'item', group: 'seed', id: 'BirchSeeds', tier: 2, weight: 0.1, stack: 100, floating: true },
  ...
  { type: 'food', group: 'berry', id: 'Blueberries', emoji: '🫐', tier: 2, weight: 0.1, stack: 50, tags: ['plant'],
    health: 8, stamina: 25, duration: 600, regen: 1, color: '#568cffff',
    grow: itemGrow({ locations: ['BlackForest'], num: [1, 2], group: [2, 3], respawn: 5 * HOUR }) },
  { type: 'food', id: 'QueensJam', emoji: '🧁', tier: 2, weight: 1, stack: 10,
    health: 14, stamina: 40, duration: 1200, regen: 2, color: '#ff0084ff',
...
/*  { type: 'food', id: 'MushroomBlue', emoji: '🍄🔵', tier: 2, weight: 0.1, stack: 50,
  ...
  { type: 'food', id: 'Carrot', emoji: '🥕', tier: 2, weight: 0.3, stack: 50, tags: ['plant', 'vegetable'],
    health: 10, stamina: 32, duration: 900, regen: 1, color: '#ff7115ff',
  },
  { type: 'food', id: 'CarrotSoup', emoji: '🥣', tier: 2, weight: 1, stack: 10,
    health: 15, stamina: 45, duration: 1500, regen: 2, color: '#f17d3aff',
    recipe: { type: 'craft_one', time: CAULDRON_TIME, materials: { Mushroom: 1, Carrot: 3 },
              source: { station: CraftingStation.Cauldron }, number: 1 },
  },
  { type: 'food', id: 'DeerStew', emoji: '🍲', tier: 2, weight: 1, stack: 10,
    health: 40, stamina: 13, duration: 1200, regen: 2, color: '#DD8049ff',
    recipe: { type: 'craft_one', time: CAULDRON_TIME, materials: { CookedDeerMeat: 1, Blueberries: 1, Carrot: 1 },
              source: { station: CraftingStation.Cauldron }, number: 1 },
  },
  { type: 'food', id: 'MinceMeatSauce', emoji: '', tier: 2, weight: 1, stack: 10,
    health: 45, stamina: 15, duration: 1500, regen: 3, color: '#DD8049ff',
  ...
  { type: 'food', id: 'TurnipStew', emoji: '🍲', tier: 3, weight: 1, stack: 10,
    health: 18, stamina: 55, duration: 1500, regen: 2, color: '#EEFF8Dff',
  ...
  { type: 'food', id: 'BlackSoup', emoji: '', tier: 3, weight: 1, stack: 10,
    health: 50, stamina: 17, duration: 1200, regen: 3, color: '#8b0e0eff',
    recipe: { type: 'craft_one', time: CAULDRON_TIME, materials: { Bloodbag: 1, Honey: 1, Turnip: 1 },
              source: { station: CraftingStation.Cauldron, level: 2 }, number: 1 } },
  { type: 'food', id: 'ShocklateSmoothie', emoji: '', tier: 3, weight: 1, stack: 10,
    health: 16, stamina: 50, duration: 1200, regen: 1, color: '#8b0e0eff',
  ...
  { type: 'food', id: 'Sausages', emoji: '🌭', tier: 3, weight: 0.5, stack: 20,
    health: 55, stamina: 18, duration: 1500, regen: 3, color: '#ce703eff',
...
// OCEAN
  ...
  { type: 'food', id: 'SerpentMeatCooked', emoji: '🍣', tier: 3, weight: 10, stack: 50,
    health: 70, stamina: 23, duration: 1500, regen: 3, color: '#c27538ff',
    recipe: { type: 'craft_one', time: 60, materials: { SerpentMeat: 1 },
              source: { station: CraftingStation.CookingStationIron }, number: 1 },
  },
  { type: 'food', id: 'SerpentStew', emoji: '🍜', tier: 3, weight: 1, stack: 10,
    health: 80, stamina: 26, duration: 1800, regen: 4, color: '#dd8049ff',
...
// MOUNTAIN
  ...
  { type: 'item', group: 'seed', id: 'OnionSeeds', emoji: '', tier: 4, weight: 0.1, stack: 100 },
  ...
  { type: 'food', id: 'CookedWolfMeat', emoji: '', tier: 4, weight: 1, stack: 20,
    health: 45, stamina: 15, duration: 1200, regen: 3, color: '#973C3AFF',
    recipe: { type: 'craft_one', time: 25, materials: { WolfMeat: 1 },
              source: { station: CraftingStation.CookingStation }, number: 1 },
  },
  { type: 'food', id: 'WolfMeatSkewer', emoji: '', tier: 4, weight: 0.5, stack: 20,
    health: 65, stamina: 21, duration: 1500, regen: 3, color: '#973C3AFF',
  ...
  { type: 'food', id: 'WolfJerky', emoji: '', tier: 4, weight: 0.5, stack: 20,
    health: 30, stamina: 30, duration: 1800, regen: 1, color: '#5D3D28FF',
    recipe: { type: 'craft_one', time: CAULDRON_TIME, materials: { WolfMeat: 1, Honey: 1 },
              source: { station: CraftingStation.Cauldron, level: 3 }, number: 2 },
  },
  { type: 'food', id: 'Eyescream', emoji: '🍦', tier: 4, weight: 0.5, stack: 10,
    health: 21, stamina: 65, duration: 1500, regen: 1, color: '#82FCFFff',
  ...
  { type: 'food', id: 'OnionSoup', emoji: '', tier: 4, weight: 1, stack: 10,
    health: 20, stamina: 60, duration: 1200, regen: 1, color: '#C56B37ff',
...
/*    recipe: { type: 'craft_one', time: 4500, materials: { Barley: 1 },
  ...
  { type: 'food', id: 'Cloudberry', emoji: '🟠', tier: 5, weight: 0.1, stack: 50, tags: ['plant'],
    health: 13, stamina: 40, duration: 900, regen: 1, color: '#ffde87ff',
  ...
  { type: 'food', id: 'CookedLoxMeat', emoji: '🍖', tier: 5, weight: 2, stack: 20,
    health: 50, stamina: 16, duration: 1200, regen: 4, color: '#d9a169ff',
    recipe: { type: 'craft_one', time: 60, materials: { LoxMeat: 1 },
              source: { station: CraftingStation.CookingStationIron }, number: 1 },
  },
  { type: 'food', id: 'BloodPudding', emoji: '🧆', tier: 5, weight: 1, stack: 10,
    health: 23, stamina: 70, duration: 1500, regen: 1, color: '#8b0e0eff',
  ...
  { type: 'food', id: 'Bread', emoji: '🍞', tier: 5, weight: 0.5, stack: 20,
    health: 25, stamina: 75, duration: 1800, regen: 1, color: '#ffca87ff',
  ...
  { type: 'food', id: 'FishWraps', emoji: '🌯', tier: 5, weight: 1, stack: 10,
    health: 70, stamina: 23, duration: 1500, regen: 4, color: '#ffe2b6ff',
  ...
  { type: 'food', id: 'LoxPie', emoji: '🥧', tier: 5, weight: 1, stack: 10,
    health: 75, stamina: 24, duration: 1800, regen: 4, color: '#ffcf33ff',
