...
/*  { type: 'item', id: 'MushroomBlue', emoji: '🍄🔵', tier: 2, weight: 0.1, stack: 50,
  ...
  { type: 'item', id: 'MeadBaseHealthMedium', tier: 1, weight: 1, stack: 1 },
  { type: 'item', id: 'MeadHealthMedium', emoji: '\u{1F9EA}', tier: 1, weight: 1, stack: 10,
    Potion: { health: [75, 10], cooldown: 120 },
  },
  { type: 'item', id: 'MeadBasePoisonResist', tier: 1, weight: 1, stack: 1 },
  ...
  { type: 'item', id: 'MeadBaseFrostResist', tier: 1, weight: 1, stack: 1 },
...
/*    recipe: { type: 'craft_one', time: 4500, materials: { Barley: 1 },
  ...
  { type: 'item', id: 'MeadBaseStaminaMedium', tier: 1, weight: 1, stack: 1 },
