...
// MEADOWS
  ...
  { type: 'item', id: 'Coal', tier: 2, weight: 2, stack: 50,
    recipe: { type: 'craft_one', time: KILN_TIME, materials: { Wood: 1 },
              source: { station: 'charcoal_kiln' }, number: 1 },
  },
  ...
  { type: 'item', id: 'CookedMeat', emoji: '🍗', tier: 1, weight: 1, stack: 20,
    ...
    recipe: { type: 'craft_one', time: 25, materials: { RawMeat: 1 },
              source: { station: 'piece_cookingstation' }, number: 1 },
  },
  { type: 'item', id: 'BoarJerky', emoji: '🥓', tier: 1, weight: 0.5, stack: 20,
    ...
    recipe: { type: 'craft_one', time: CAULDRON_TIME, materials: { RawMeat: 1, Honey: 1 },
              source: { station: 'piece_cauldron' }, number: 2 },
  },
  ...
  { type: 'item', id: 'MeadHealthMinor', emoji: '\u{1F9EA}', tier: 1, weight: 1, stack: 10,
    ...
    recipe: { type: 'craft_one', time: FERMENT_TIME, materials: { Honey: 10, Blueberries: 5, Raspberry: 10, Dandelion: 1 },
              source: { station: 'fermenter' }, number: 6 },
  },
...
// BLACK FOREST
  ...
  { type: 'item', group: 'metal', id: 'Copper', tier: 2, weight: 10, stack: 30, teleportable: false, tags: ['metal'],
    recipe: { type: 'craft_one', time: SMELTER_TIME, materials: { CopperOre: 1, Coal: 2 },
              source: { station: 'smelter' }, number: 1 },
  },
  ...
  { type: 'item', id: 'QueensJam', emoji: '🧁', tier: 2, weight: 1, stack: 10,
    ...
    recipe: { type: 'craft_one', time: CAULDRON_TIME, materials: { Raspberry: 8, Blueberries: 6 },
              source: { station: 'piece_cauldron' }, number: 4 },
  },
...
/*  { type: 'item', id: 'MushroomBlue', emoji: '🍄🔵', tier: 2, weight: 0.1, stack: 50,
  ...
  { type: 'item', id: 'CarrotSoup', emoji: '🥣', tier: 2, weight: 1, stack: 10,
    ...
    recipe: { type: 'craft_one', time: CAULDRON_TIME, materials: { Mushroom: 1, Carrot: 3 },
              source: { station: 'piece_cauldron' }, number: 1 },
  },
  ...
  { type: 'item', id: 'TurnipStew', emoji: '🍲', tier: 3, weight: 1, stack: 10,
    ...
    recipe: { type: 'craft_one', time: CAULDRON_TIME, materials: { RawMeat: 1, Turnip: 3 },
              source: { station: 'piece_cauldron', level: 2 }, number: 1 },
  },
  ...
  { type: 'item', id: 'Sausages', emoji: '🌭', tier: 3, weight: 0.5, stack: 20,
    ...
    recipe: { type: 'craft_one', time: CAULDRON_TIME, materials: { Entrails: 2, RawMeat: 1, Thistle: 4 },
              source: { station: 'piece_cauldron', level: 2 }, number: 4 } },
...
// OCEAN
  ...
  { type: 'item', id: 'SerpentMeatCooked', emoji: '🍣', tier: 3, weight: 10, stack: 50,
    ...
    recipe: { type: 'craft_one', time: 60, materials: { SerpentMeat: 1 },
              source: { station: 'piece_cookingstation_iron' }, number: 1 },
  },
...
// MOUNTAIN
  ...
  { type: 'trophy', id: 'TrophyUlv', tier: 4, weight: 1.5, stack: 20 },
  { type: 'trophy', id: 'TrophyCultist', tier: 4, weight: 3, stack: 20 },
  ...
  { type: 'item', id: 'WolfMeatSkewer', emoji: '', tier: 4, weight: 0.5, stack: 20,
    ...
    recipe: { type: 'craft_one', time: CAULDRON_TIME, materials: { WolfMeat: 1, Mushroom: 2, Onion: 1 },
              source: { station: 'piece_cauldron', level: 3 }, number: 2 },
  },
  ...
  { type: 'item', id: 'Eyescream', emoji: '🍦', tier: 4, weight: 0.5, stack: 10,
    ...
    recipe: { type: 'craft_one', time: CAULDRON_TIME, materials: { GreydwarfEye: 3, FreezeGland: 1 },
              source: { station: 'piece_cauldron', level: 3 }, number: 1 },
  },
...
/*    recipe: { type: 'craft_one', time: 4500, materials: { Flax: 1 },
  ...
  { type: 'item', id: 'LinenThread', tier: 5, weight: 2, stack: 50,
    recipe: { type: 'craft_one', time: SPIN_WHEEL_TIME, materials: { Flax: 1 },
              source: { station: 'piece_spinningwheel' }, number: 1 },
  },
...
/*    recipe: { type: 'craft_one', time: 4500, materials: { Barley: 1 },
  ...
  { type: 'item', id: 'BarleyFlour', tier: 5, weight: 0.2, stack: 20,
    recipe: { type: 'craft_one', time: 10, materials: { Barley: 1 },
              source: { station: 'windmill' }, number: 1 } },
  ...
  { type: 'item', id: 'BloodPudding', emoji: '🧆', tier: 5, weight: 1, stack: 10,
    ...
    recipe: { type: 'craft_one', time: CAULDRON_TIME, materials: { Bloodbag: 2, BarleyFlour: 4, Thistle: 2 },
              source: { station: 'piece_cauldron', level: 4 }, number: 1 } },
  { type: 'item', id: 'BreadDough', emoji: '', tier: 5, weight: 0.5, stack: 20,
    recipe: { type: 'craft_one', time: CAULDRON_TIME, materials: { BarleyFlour: 10 },
              source: { station: 'piece_cauldron', level: 4 }, number: 2 },
  },
  { type: 'item', id: 'Bread', emoji: '🍞', tier: 5, weight: 0.5, stack: 20,
    ...
    recipe: { type: 'craft_one', time: 50, materials: { BreadDough: 1 },
              source: { station: 'piece_oven' }, number: 1 },
  },
  ...
  { type: 'item', group: 'metal', id: 'BlackMetal', tier: 5, weight: 12, stack: 30, teleportable: false, tags: ['metal'],
    recipe: { type: 'craft_one', time: FURNACE_TIME, materials: { BlackMetalScrap: 1, Coal: 2 },
              source: { station: 'blastfurnace' }, number: 1 },
  },
  { type: 'item', id: 'SaddleLox', tier: 5, weight: 10, stack: 1,
    recipe: { type: 'craft_one', time: 2, materials: { LeatherScraps: 10, LinenThread: 20, BlackMetal: 15 },
              source: { station: 'forge', level: 3 }, number: 1 },
  },
