...
export const recipes: ItemRecipe[] = [
  ...
  workbenchRecipe(1, { Wood: 4, AxeHead1: 1, AxeHead2: 1 }, { Wood: 2, LeatherScraps: 2 }, 'AxeEarly'),
  ...
  // WOODEN
  workbenchRecipe(1, { Wood: 5, FineWood: 3, RoundLog: 2 }, { Wood: 1, FineWood: 10, RoundLog: 2 }, 'AxeWood'),
  workbenchRecipe(1, { Wood: 5, FineWood: 3, RoundLog: 2 }, { Wood: 1, FineWood: 10, RoundLog: 2 }, 'AtgeirWood'),
  workbenchRecipe(1, { Wood: 5, FineWood: 3, RoundLog: 2 }, { Wood: 1, FineWood: 10, RoundLog: 2 }, 'BattleaxeWood'),
  workbenchRecipe(1, { Wood: 5, FineWood: 3, RoundLog: 2 }, { Wood: 1, FineWood: 10, RoundLog: 2 }, 'KnifeWood'),
  workbenchRecipe(1, { Wood: 5, FineWood: 3, RoundLog: 2 }, { Wood: 1, FineWood: 10, RoundLog: 2 }, 'MaceWood'),
  workbenchRecipe(1, { Wood: 5, FineWood: 3, RoundLog: 2 }, { Wood: 1, FineWood: 10, RoundLog: 2 }, 'SledgeWood'),
  workbenchRecipe(1, { Wood: 5, FineWood: 3, RoundLog: 2 }, { Wood: 1, FineWood: 10, RoundLog: 2 }, 'SpearWood'),
  workbenchRecipe(1, { Wood: 5, FineWood: 3, RoundLog: 2 }, { Wood: 1, FineWood: 10, RoundLog: 2 }, 'SwordWood'),
  workbenchRecipe(1, { Wood: 5, FineWood: 3, RoundLog: 2 }, { Wood: 1, FineWood: 10, RoundLog: 2 }, 'THSwordWood'),
  // LEVEL 2
  ...
  workbenchRecipe(2, { BjornHide: 5, Blueberries: 4 }, { BjornHide: 2, Blueberries: 1 }, 'ArmorBerserkerLegs'),
  workbenchRecipe(2, { BjornHide: 5, BjornPaw: 2, Blueberries: 4 }, { BjornHide: 2, Blueberries: 1 }, 'ArmorBerserkerChest'),
  workbenchRecipe(2, { BjornHide: 5, TrophyBjorn: 1 }, { BjornHide: 2 }, 'HelmetBerserkerHood'),
  workbenchRecipe(2, { DeerHide: 2, BjornHide: 1, Bronze: 1, AmberPearl: 1 }, { DeerHide: 1, Bronze: 1 }, 'HelmetCelebration'),
  ...
  workbenchRecipe(2, { BjornHide: 2, BjornPaw: 2, LeatherScraps: 4 }, { BjornHide: 2, LeatherScraps: 2 }, 'FistBjornClaw'),
  workbenchRecipe(2, { FineWood: 8, Chitin: 30, LeatherScraps: 3 }, {}, 'SpearChitin'),
  workbenchRecipe(2, { FineWood: 4, Chitin: 20, LeatherScraps: 2 }, { Chitin: 10 }, 'KnifeChitin'),
  workbenchRecipe(2, { LinenThread: 20, Silver: 1 }, { LinenThread: 4 }, 'CapeLinen'),
  ...
  workbenchRecipe(2, { LoxPelt: 4, BoneFragments: 4, WrithanRoots: 2 }, { LoxPelt: 2, BoneFragments: 2, WrithanRoots: 1 }, 'HelmetLox'),
  workbenchRecipe(2, { LoxPelt: 5, BoneFragments: 8, Root: 2 }, { LoxPelt: 6, BoneFragments: 4, Root: 1 }, 'ArmorLoxLegs'),
  workbenchRecipe(2, { LoxPelt: 5, BoneFragments: 8, Root: 2 }, { LoxPelt: 6, BoneFragments: 4, Root: 1 }, 'ArmorLoxChest'),
  // ARROWS & BOMBS
  ...
  workbenchRecipe(1, { BlobVial: 1, TrophyBlob: 1, Resin: 3 }, {}, 'BombBlob_Poison'),
  workbenchRecipe(1, { BlobVial: 1, TrophyBlob: 3, Resin: 3 }, {}, 'BombBlob_PoisonElite'),
  workbenchRecipe(1, { BlobVial: 1, TrophyHatchling: 1, Resin: 3 }, {}, 'BombBlob_Frost'),
  workbenchRecipe(1, { BlobVial: 1, TrophyGrowth: 1, Resin: 3 }, {}, 'BombBlob_Tar'),
  workbenchRecipe(1, { BlobVial: 1, SulfurStone: 10, ProustitePowder: 10 }, {}, 'BombBlob_Lava'),
  workbenchRecipe(1, { Grausten: 10 }, {}, 'Catapult_ammo', 5),
  workbenchRecipe(1, { AskHide: 2, SulfurStone: 2, ProustitePowder: 3 }, {}, 'BombSiege', 5),
  workbenchRecipe(1, { SealHide: 2, FaderEmber: 1 }, {}, 'BombDynamite', 10),
  blackForgeRecipe(1, { Ice: 2, Gold: 2, ProustitePowder: 3 }, {}, 'Catapult_Ammo_BloodGold', 5),
  // FIREWORKS
  ...
  genericRecipe('piece_FrostKiln', 1, 30, { Ice: 5 }, {}, 'FrozenFuel'),
  // genericRecipe('charcoal_kiln', 1, KILN_TIME, { ElderBark: 1 }, {}, 'Coal'),
  
  // frozenFoundryRecipe
  frostFoundryRecipe('SwordGoldUncooked', 'SwordGold'),
  frostFoundryRecipe('AtgeirGoldUncooked', 'AtgeirGold'),
  frostFoundryRecipe('BattleaxeGoldUncooked', 'BattleaxeGold'),
  frostFoundryRecipe('AxeGoldUncooked', 'AxeGold'),
  frostFoundryRecipe('BowGoldUncooked', 'BowGold'),
  frostFoundryRecipe('CrossbowGoldUncooked', 'CrossbowGold'),
  frostFoundryRecipe('FistGoldUncooked', 'FistGold'),
  frostFoundryRecipe('KnifeGoldUncooked', 'KnifeGold'),
  frostFoundryRecipe('SledgeGoldUncooked', 'SledgeGold'),
  frostFoundryRecipe('MaceGoldUncooked', 'MaceGold'),
  frostFoundryRecipe('SpearGoldUncooked', 'SpearGold'),
  frostFoundryRecipe('THSwordGoldUncooked', 'THSwordGold'),
  frostFoundryRecipe('ArmorGoldHeavyChestUncooked', 'ArmorDeepNorthHeavyChest'),
  frostFoundryRecipe('ArmorGoldHeavyLegsUncooked', 'ArmorDeepNorthHeavylegs'),
  frostFoundryRecipe('ArmorGoldHeavyHelmetUncooked', 'HelmetDNHeavy'),
  frostFoundryRecipe('ArmorGoldMediumHelmetUncooked', 'HelmetDNMediumHood'),
  frostFoundryRecipe('ArmorGoldMediumChestUncooked', 'ArmorDeepNorthMediumChest'),
  frostFoundryRecipe('ArmorGoldMediumLegsUncooked', 'ArmorDeepNorthMediumlegs'),
  frostFoundryRecipe('ArmorGoldMageLegsUncooked', 'ArmorDeepNorthMagelegs'),
  frostFoundryRecipe('ArmorGoldMageChestUncooked', 'ArmorDeepNorthMageChest'),
  frostFoundryRecipe('ArmorGoldMageHelmetUncooked', 'HelmetDNMage'),
  frostFoundryRecipe('ShieldBucklerGoldUncooked', 'ShieldGoldBuckler'),
  frostFoundryRecipe('ShieldRoundGoldUncooked', 'ShieldGold'),
  frostFoundryRecipe('ShieldTowerGoldUncooked', 'ShieldGoldTower'),
  frostFoundryRecipe('KeysGoldUncooked', 'BloodGoldKey'),
  frostFoundryRecipe('StaffSpiritCallerUncooked', 'StaffSpiritCaller'),
  frostFoundryRecipe('StaffOrbofAhriUncooked', 'StaffOrbofAhri'),
  frostFoundryRecipe('StaffFrostOrbsUncooked', 'StaffFrostOrbs'),
  frostFoundryRecipe('StaffThunderbloodUncooked', 'StaffThunderBlood'),
  ...
  genericRecipe('piece_cookingstation', 1, 25, { BjornMeat: 1 }, {}, 'CookedBjornMeat'),
  ...
  genericRecipe('piece_cookingstation_iron', 1, 25, { BjornMeat: 1 }, {}, 'CookedBjornMeat'),
  genericRecipe('piece_cookingstation_iron', 1, 25, { MooseMeat: 1 }, {}, 'CookedMooseMeat'),
  // CAULDRON
  ...
  prepTableRecipe(1, { Cloudberry: 2, ChickenEgg: 1, BarleyFlour: 1, Honey: 1 }, 'VikingCupcakeUncooked'),
  // LEVEL 5
  ...
  // LEVEL 7
  cauldronRecipe(7, { FishRaw: 3, Kale: 2, Ice: 2 }, 'FishSoup'),
  cauldronRecipe(6, { Kale: 12 }, 'KaleChipsUncooked', 4),
  cauldronRecipe(6, { Lingonberry: 5, Ice: 5 }, 'Lingondricka'),
  cauldronRecipe(7, { MooseMeat: 1, Kale: 2, OatFlour: 1, Lingonberry: 2 }, 'MooseKebab', 2),
  cauldronRecipe(7, { MooseMeat: 1, Lingonberry: 2, Poteitr: 2 }, 'MeatballsMashedPoteitr'),
  cauldronRecipe(6, { Oat: 2, Lingonberry: 2, OatMilk: 1 }, 'OatmealLingonberryJam'),
  cauldronRecipe(6, { MooseMeat: 1, Poteitr: 2, Lingonberry: 2, OatFlour: 2 }, 'OvenPancakeUncooked'),
  cauldronRecipe(7, { SealBlubber: 1, Kale: 2, Poteitr: 1, OatFlour: 2 }, 'BakedPoteitrUncooked'),
  cauldronRecipe(6, { OatMilk: 1, OatFlour: 2, ChickenEgg: 2, Blueberries: 2 }, 'Pancakes', 3),
  cauldronRecipe(7, { SealBlubber: 2, Kale: 2, Ice: 2 }, 'SealSoup'),
  cauldronRecipe(7, { FishRaw: 1, Kale: 1, Poteitr: 1 }, 'SmokedFish'),
  cauldronRecipe(7, { MooseMeat: 1, Kale: 2 }, 'SmokedMooseMeat'),
  meadCauldronRecipe(1, { OatFlour: 5, Ice: 5 }, 'OatMilk'),
  // BAITS
  ...
  prepTableRecipe(1, { CookedMooseMeat: 3, Poteitr: 5, OatFlour: 2, SpiceDeepNorth: 1 }, 'FeastDeepNorth_Material', 10),
  // FERMENTER
  ...potionRecipe(
  ...
  smelterRecipe('blastfurnace', 'GoldOre', 'Gold'),
  ...
  forgeRecipe(1, { BlackMetal: 5, LoxPelt: 5, TrophyLox: 1 }, {}, 'TrinketBlackDamageHealth'),
  forgeRecipe(1, { BlackMetal: 5, TrophyGoblinBrute: 1, LinenThread: 10 }, {}, 'TrinketBlackStamina'),
  forgeRecipe(1, { Bronze: 5, AncientSeed: 5, TrophyGreydwarfShaman: 1 }, {}, 'TrinketBronzeHealth'),
  forgeRecipe(1, { Bronze: 5, TrophyBjorn: 1, Ruby: 3 }, {}, 'TrinketBronzeStamina'),
  forgeRecipe(1, { Chitin: 5, SerpentScale: 5, TrophySerpent: 1 }, {}, 'TrinketChitinSwim'),
  forgeRecipe(1, { Iron: 5, ElderBark: 5, TrophyLeech: 1 }, {}, 'TrinketIronHealth'),
  forgeRecipe(1, { Iron: 5, WitheredBone: 5, TrophySurtling: 1 }, {}, 'TrinketIronStamina'),
  forgeRecipe(1, { Silver: 5, WolfFang: 5, TrophyFenring: 1 }, {}, 'TrinketSilverDamage'),
  forgeRecipe(1, { Silver: 5, Crystal: 5, TrophySGolem: 1 }, {}, 'TrinketSilverResist'),
  // IRON
  ...
  forgeRecipe(2, { ElderBark: 4, Iron: 10 }, { ElderBark: 1, Iron: 5 }, 'ShieldIronBuckler'),
  forgeRecipe(2, { Iron: 20, DeerHide: 2 }, { Iron: 5 }, 'ArmorIronLegs'),
  ...
  workbenchRecipe(2, { FineWood: 10, WrithanRoots: 1 }, { FineWood: 5, WrithanRoots: 2 }, 'ShieldRoots'),
  // SILVER
  ...
  forgeRecipe(4, { BjornHide: 2, UndeadBjornRibcage: 2, BlackMetal: 2, LinenThread: 4 }, { BjornHide: 1, BlackMetal: 1, LinenThread: 2 }, 'FistBjornUndeadClaw'),
  forgeRecipe(2, { BjornHide: 10, UndeadBjornRibcage: 1, LinenThread: 4 }, { BjornHide: 5, UndeadBjornRibcage: 1, LinenThread: 1 }, 'ArmorBerserkerUndeadLegs'),
  forgeRecipe(2, { BjornHide: 4, UndeadBjornRibcage: 3, LinenThread: 4 }, { BjornHide: 2, UndeadBjornRibcage: 1, LinenThread: 1 }, 'ArmorBerserkerUndeadChest'),
  forgeRecipe(2, { BjornHide: 5, TrophyBjornUndead: 1 }, { BjornHide: 2 }, 'HelmetBerserkerUndead'),
  ...
  forgeRecipe(4, { FineWood: 10, BlackMetal: 30, LinenThread: 5 }, { BlackMetal: 15, LinenThread: 5 }, 'BattleaxeBlackmetal'),
  ...
  genericRecipe('piece_artisanstation', 1, 3, { Frostwood: 10, Gold: 1 }, {}, 'TurretBoltBloodgold', 20),
  ...
  // BLACK FORGE
  blackForgeRecipe(3, { FineWood: 2, FlametalNew: 4, FaderEmber: 2 }, { FlametalNew: 10, Crystal: 1 }, 'Shovel'),
  ...
  blackForgeRecipe(1, { FineWood: 10, BlackMetal: 30, LinenThread: 5 }, { BlackMetal: 15, LinenThread: 5 }, 'BattleaxeSkullSplittur'),
  ...
  blackForgeRecipe(1, { Eitr: 5, ScaleHide: 5, Mandible: 1, TrophySeeker: 1 }, {}, 'TrinketScaleStaminaDamage'),
  blackForgeRecipe(1, { Carapace: 5, Eitr: 5, TrophyGjall: 1 }, {}, 'TrinketCarapaceEitr'),
  blackForgeRecipe(1, { YggdrasilWood: 10, Eitr: 10, Mandible: 4, Hook: 1 }, { YggdrasilWood: 5, Eitr: 4, Mandible: 1, Hook: 1 }, 'GrapplingHook'),
// ASHLANDS
  // BowAshlands
  ...
  blackForgeRecipe(1, { FlametalNew: 5, Eitr: 5, GemstoneRed: 1, TrophyFallenValkyrie: 1 }, {}, 'TrinketFlametalEitr'),
  blackForgeRecipe(1, { FlametalNew: 5, SulfurStone: 5, MoltenCore: 1, TrophyMorgen: 1 }, {}, 'TrinketFlametalStaminaHealth'),
...
// DEEP NORTH
  blackForgeRecipe(4, { Gold: 20, MoldAtgeir: 1, Frostwood: 10 }, { Gold: 10, Frostwood: 5 }, 'AtgeirGoldUncooked'),
  blackForgeRecipe(4, { AtgeirGold: 1, Gold: 20, OrbThunderBlood: 1 }, { Gold: 10, Frostwood: 5 }, 'AtgeirGold_BloodLightning'),
  blackForgeRecipe(4, { AtgeirGold: 1, Gold: 20, OrbFrostFire: 1 }, { Gold: 10, Frostwood: 5 }, 'AtgeirGold_FrostFire'),
  blackForgeRecipe(4, { Gold: 20, MoldAxe: 1, Frostwood: 10 }, { Gold: 10, Frostwood: 5 }, 'AxeGoldUncooked'),
  blackForgeRecipe(4, { AxeGold: 1, Gold: 20, OrbThunderBlood: 1 }, { Gold: 10, Frostwood: 5 }, 'AxeGold_BloodLightning'),
  blackForgeRecipe(4, { AxeGold: 1, Gold: 20, OrbFrostFire: 1 }, { Gold: 10, Frostwood: 5 }, 'AxeGold_FrostFire'),
  blackForgeRecipe(4, { Gold: 20, MoldAxe2H: 1, Frostwood: 10 }, { Gold: 15, Frostwood: 3 }, 'BattleaxeGoldUncooked'),
  blackForgeRecipe(4, { BattleaxeGold: 1, Gold: 20, OrbThunderBlood: 1 }, { Gold: 10, Frostwood: 5 }, 'BattleaxeGold_BloodLightning'),
  blackForgeRecipe(4, { BattleaxeGold: 1, Gold: 20, OrbFrostFire: 1 }, { Gold: 10, Frostwood: 5 }, 'BattleaxeGold_FrostFire'),
  blackForgeRecipe(4, { Gold: 20, MoldBow: 1, Frostwood: 10 }, { Gold: 10, Frostwood: 5 }, 'BowGoldUncooked'),
  blackForgeRecipe(4, { BowGold: 1, Gold: 20, OrbThunderBlood: 1 }, { Gold: 10, Frostwood: 5 }, 'BowGold_BloodLightning'),
  blackForgeRecipe(4, { BowGold: 1, Gold: 20, OrbFrostFire: 1 }, { Gold: 10, Frostwood: 5 }, 'BowGold_FrostFire'),
  blackForgeRecipe(4, { Gold: 20, MoldCrossbow: 1, Frostwood: 10 }, { Gold: 10, Frostwood: 5 }, 'CrossbowGoldUncooked'),
  blackForgeRecipe(4, { CrossbowGold: 1, Gold: 20, OrbThunderBlood: 1 }, { Gold: 10, Frostwood: 5 }, 'CrossbowGold_BloodLightning'),
  blackForgeRecipe(4, { CrossbowGold: 1, Gold: 20, OrbFrostFire: 1 }, { Gold: 10, Frostwood: 5 }, 'CrossbowGold_FrostFire'),
  blackForgeRecipe(4, { Gold: 20, MoldFistweapon: 1, Frostwood: 10 }, { Gold: 10, Frostwood: 5 }, 'FistGoldUncooked'),
  blackForgeRecipe(4, { FistGold: 1, Gold: 20, OrbThunderBlood: 1 }, { Gold: 10, Frostwood: 5 }, 'FistGold_BloodLightning'),
  blackForgeRecipe(4, { FistGold: 1, Gold: 20, OrbFrostFire: 1 }, { Gold: 10, Frostwood: 5 }, 'FistGold_FrostFire'),
  blackForgeRecipe(4, { Gold: 20, MoldSpear: 1, Frostwood: 10 }, { Gold: 10, Frostwood: 5 }, 'SpearGoldUncooked'),
  blackForgeRecipe(4, { SpearGold: 1, Gold: 20, OrbThunderBlood: 1 }, { Gold: 10, Frostwood: 5 }, 'SpearGold_BloodLightning'),
  blackForgeRecipe(4, { SpearGold: 1, Gold: 20, OrbFrostFire: 1 }, { Gold: 10, Frostwood: 5 }, 'SpearGold_FrostFire'),
  blackForgeRecipe(4, { Gold: 20, MoldMace: 1, Frostwood: 10 }, { Gold: 10, Frostwood: 5 }, 'MaceGoldUncooked'),
  blackForgeRecipe(4, { MaceGold: 1, Gold: 20, OrbThunderBlood: 1 }, { Gold: 10, Frostwood: 5 }, 'MaceGold_BloodLightning'),
  blackForgeRecipe(4, { MaceGold: 1, Gold: 20, OrbFrostFire: 1 }, { Gold: 10, Frostwood: 5 }, 'MaceGold_FrostFire'),
  blackForgeRecipe(4, { Gold: 20, MoldMace2H: 1, Frostwood: 10 }, { Gold: 10, Frostwood: 5 }, 'SledgeGoldUncooked'),
  blackForgeRecipe(4, { SledgeGold: 1, Gold: 20, OrbThunderBlood: 1 }, { Gold: 10, Frostwood: 5 }, 'SledgeGold_BloodLightning'),
  blackForgeRecipe(4, { SledgeGold: 1, Gold: 20, OrbFrostFire: 1 }, { Gold: 10, Frostwood: 5 }, 'SledgeGold_FrostFire'),
  blackForgeRecipe(4, { Gold: 20, MoldSword: 1, Frostwood: 10 }, { Gold: 10, Frostwood: 5 }, 'SwordGoldUncooked'),
  blackForgeRecipe(4, { SwordGold: 1, Gold: 20, OrbThunderBlood: 1 }, { Gold: 10, Frostwood: 5 }, 'SwordGold_BloodLightning'),
  blackForgeRecipe(4, { SwordGold: 1, Gold: 20, OrbFrostFire: 1 }, { Gold: 10, Frostwood: 5 }, 'SwordGold_FrostFire'),
  blackForgeRecipe(4, { Gold: 20, MoldSword2H: 1, Frostwood: 10 }, { Gold: 10, Frostwood: 5 }, 'THSwordGoldUncooked'),
  blackForgeRecipe(4, { THSwordGold: 1, Gold: 20, OrbThunderBlood: 1 }, { Gold: 10, Frostwood: 5 }, 'THSwordGold_BloodLightning'),
  blackForgeRecipe(4, { THSwordGold: 1, Gold: 20, OrbFrostFire: 1 }, { Gold: 10, Frostwood: 5 }, 'THSwordGold_FrostFire'),
  blackForgeRecipe(4, { Gold: 20, MoldKnife: 1, Frostwood: 10 }, { Gold: 10, Frostwood: 5 }, 'KnifeGoldUncooked'),
  blackForgeRecipe(4, { KnifeGold: 1, Gold: 20, OrbThunderBlood: 1 }, { Gold: 10, Frostwood: 5 }, 'KnifeGold_BloodLightning'),
  blackForgeRecipe(4, { KnifeGold: 1, Gold: 20, OrbFrostFire: 1 }, { Gold: 10, Frostwood: 5 }, 'KnifeGold_FrostFire'),
  blackForgeRecipe(4, { MoldShieldBuckler: 1, Gold: 10, Frostwood: 10 }, {}, 'ShieldBucklerGoldUncooked'),
  blackForgeRecipe(4, { MoldShieldRound: 1, Gold: 15, Frostwood: 10 }, {}, 'ShieldRoundGoldUncooked'),
  blackForgeRecipe(4, { MoldShieldTower: 1, Gold: 20, Frostwood: 20 }, {}, 'ShieldTowerGoldUncooked'),
  blackForgeRecipe(4, { MoldKeys: 1, Gold: 5 }, {}, 'KeysGoldUncooked'),
  blackForgeRecipe(4, { Gold: 20, MoldArmorGoldChest: 1, MooseHide: 8, Leatherstraps: 4 }, {}, 'ArmorGoldHeavyChestUncooked'),
  blackForgeRecipe(4, { Gold: 20, MoldArmorGoldLegs: 1, MooseHide: 8, Leatherstraps: 4 }, {}, 'ArmorGoldHeavyLegsUncooked'),
  blackForgeRecipe(4, { Gold: 20, MoldArmorGoldHelmet: 1, MooseHide: 4, Leatherstraps: 4 }, {}, 'ArmorGoldHeavyHelmetUncooked'),
  blackForgeRecipe(4, { Gold: 12, MoldArmormediumChest: 1, ElakingHairBundle: 8, SealHide: 4 }, {}, 'ArmorGoldMediumChestUncooked'),
  blackForgeRecipe(4, { Gold: 12, MoldArmorMediumLegs: 1, ElakingHairBundle: 8, SealHide: 4 }, {}, 'ArmorGoldMediumLegsUncooked'),
  blackForgeRecipe(4, { Gold: 12, MoldArmorMediumHelmet: 1, SealHide: 5, MooseHide: 5, MooseSinew: 1 }, {}, 'ArmorGoldMediumHelmetUncooked'),
  blackForgeRecipe(4, { Gold: 5, CrownJewel: 1 }, {}, 'HelmetCrownofValheim'),
  blackForgeRecipe(4, { Gold: 5, MooseHide: 6, MooseSinew: 2 }, { Gold: 2, MooseHide: 3, MooseSinew: 1 }, 'CapeDeepNorth'),
  // blackForgeRecipe(4, { Gold: 20, MoldArmorGoldLegs: 1, MooseHide: 8, Leatherstraps: 4 }, {}, 'ArmorGoldLegs'),
  // blackForgeRecipe(4, { Gold: 20, MoldArmorGoldChest: 1, MooseHide: 8, Leatherstraps: 4 }, {}, 'ArmorGoldChest'),
  // blackForgeRecipe(4, { Gold: 6, MoldArmorMageChest: 1, MooseHide: 6, NornThread: 5 }, { Gold: 3, MooseHide: 5, NornThread: 3 }, 'ArmorDeepNorthMageChest'),
  // blackForgeRecipe(4, { Gold: 6, MoldArmorMageLegs: 1, MooseHide: 6 }, { Gold: 3, MooseHide: 3 }, 'ArmorDeepNorthMagelegs'),
  // blackForgeRecipe(4, { Gold: 6, MoldArmorMageLegs: 1, MooseHide: 6 }, { Gold: 3, MooseHide: 3 }, 'ArmorDeepNorthMagelegs'),
  // blackForgeRecipe(4, { Gold: 12, MoldArmormediumChest: 1, ElakingHairBundle: 8, Leatherstraps: 4 }, { Gold: 6, ElakingHairBundle: 4, Leatherstraps: 2 }, 'ArmorDeepNorthMediumChest'),
  // blackForgeRecipe(4, { Gold: 12, MoldArmorMediumLegs: 1, ElakingHairBundle: 8, SealHide: 4 }, { Gold: 6, ElakingHairBundle: 4, SealHide: 2 }, 'ArmorDeepNorthMediumlegs'),
  ...
  blackForgeRecipe(1, { Gold: 1, Feathers: 2, Frostwood: 8 }, {}, 'ArrowBloodGold', 20),
  blackForgeRecipe(1, { Gold: 1, Feathers: 2, Frostwood: 8 }, {}, 'BoltBloodGold', 20),
  blackForgeRecipe(2, { Gold: 4, SealHide: 5, Frostwood: 5, LinenThread: 15 }, {}, 'SaddleMoose'),
  blackForgeRecipe(1, { Gold: 5, MoleClaws: 5, TrophyMoose: 1 }, {}, 'TrinketBloodGoldHealth'),
  blackForgeRecipe(1, { Gold: 5, NornThread: 5, TrophyJotunWitch: 1 }, {}, 'TrinketBloodGoldStamina'),
  ...
  mageTableRecipe(3, { MoldStafffrostorbs: 1, Ice: 10, NornThread: 5, TrophyJotunWitch: 1 }, {}, 'StaffFrostOrbsUncooked'),
  mageTableRecipe(3, { MoldStaffspiritcaller: 1, BarkaBranch: 8, NornThread: 5, TrophyMoose: 1 }, {}, 'StaffSpiritCallerUncooked'),
  mageTableRecipe(3, { MoldStaffOrbofAhri: 1, Gold: 10, NornThread: 4, OrbFrostFire: 1 }, {}, 'StaffOrbofAhriUncooked'),
  mageTableRecipe(3, { MoldStaffthunderblood: 1, Gold: 10, NornThread: 5, OrbThunderBlood: 1 }, {}, 'StaffThunderbloodUncooked'),
  mageTableRecipe(3, { Gold: 6, MoldArmorMageChest: 1, MooseHide: 6, NornThread: 5 }, {}, 'ArmorGoldMageChestUncooked'),
  mageTableRecipe(3, { Gold: 6, MoldArmorMageLegs: 1, MooseHide: 6, NornThread: 5 }, {}, 'ArmorGoldMageLegsUncooked'),
  mageTableRecipe(3, { MooseSinew: 2, MoldArmorMageHelmet: 1, TrophyMoose: 1, NornThread: 3 }, {}, 'ArmorGoldMageHelmetUncooked'),
  mageTableRecipe(4, { SealHide: 6, NornThread: 2, Gold: 5, Eitr: 15 }, { SealHide: 3, NornThread: 1, Gold: 2, Eitr: 5 }, 'CapeDeepNorthMage'),
  ...
  genericRecipe('windmill', 1, 10, { Barley: 1 }, {}, 'BarleyFlour'),
  genericRecipe('windmill', 1, 10, { OatSeeds: 1 }, {}, 'Oat'),
  genericRecipe('windmill', 1, 10, { Oat: 1 }, {}, 'OatFlour'),
  ovenRecipe('LoxPieUncooked', 'LoxPie'),
  ovenRecipe('BreadDough', 'Bread'),
  ovenRecipe('FishAndBreadUncooked', 'FishAndBread'),
  ovenRecipe('MeatPlatterUncooked', 'MeatPlatter'),
  ovenRecipe('HoneyGlazedChickenUncooked', 'HoneyGlazedChicken'),
  ovenRecipe('MisthareSupremeUncooked', 'MisthareSupreme'),
  ovenRecipe('MagicallyStuffedShroomUncooked', 'MagicallyStuffedShroom'),
  ovenRecipe('RoastedCrustPieUncooked', 'RoastedCrustPie'),
  ovenRecipe('PiquantPieUncooked', 'PiquantPie'),
  ovenRecipe('VikingCupcakeUncooked', 'VikingCupcake'),
  ovenRecipe('SealBlubber', 'CookedSealBlubber'),
  ovenRecipe('OvenPancakeUncooked', 'OvenPancake'),
  ovenRecipe('KaleChipsUncooked', 'KaleChips'),
  ovenRecipe('BakedPoteitrUncooked', 'BakedPoteitr'),
  // TRADER
  ...
  hildirRecipe(175, 'HelmetSweatBand'),
  ...
  bogWitchRecipe(220, 'SpiceDeepNorth', { number: 5, killed: 'FrozenKing' }),
  bogWitchRecipe(150, 'BlobVial', { number: 5, killed: 'gd_king' }),
  bogWitchRecipe(3000, 'HelmetRootCrown', { killed: 'Writhan' }),
  // PRODUCERS
  genericRecipe('piece_beehive', 1, GAME_DAY, {}, {}, 'Honey', 1),
  genericRecipe('piece_birdnest', 1, 1200, {}, {}, 'Feathers', 1),
  genericRecipe('piece_wisplure', 1, 30, {}, {}, 'Wisp', 1),
  genericRecipe('piece_EternalPyre', 1, 30, {}, {}, 'FaderEmber', 1),
