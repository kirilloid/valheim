...
export const recipes: ItemRecipe[] = [
  ...
  // HILDIR
  traderRecipe(450, 'ArmorDress2', { killed: 'Fenring_Cultist_Hildir' }),
  traderRecipe(550, 'ArmorDress3', { killed: 'GoblinBruteBros' }),
  traderRecipe(450, 'ArmorDress5', { killed: 'Fenring_Cultist_Hildir' }),
  traderRecipe(550, 'ArmorDress6', { killed: 'GoblinBruteBros' }),
  traderRecipe(450, 'ArmorDress8', { killed: 'Fenring_Cultist_Hildir' }),
  traderRecipe(550, 'ArmorDress9', { killed: 'GoblinBruteBros' }),
  traderRecipe(250, 'ArmorDress10'),
  traderRecipe(450, 'ArmorTunic2', { killed: 'Fenring_Cultist_Hildir' }),
  traderRecipe(550, 'ArmorTunic3', { killed: 'GoblinBruteBros' }),
  traderRecipe(450, 'ArmorTunic5', { killed: 'Fenring_Cultist_Hildir' }),
  traderRecipe(550, 'ArmorTunic6', { killed: 'GoblinBruteBros' }),
  traderRecipe(450, 'ArmorTunic8', { killed: 'Fenring_Cultist_Hildir' }),
  traderRecipe(550, 'ArmorTunic9', { killed: 'GoblinBruteBros' }),
  traderRecipe(250, 'ArmorTunic10'),
  traderRecipe(350, 'ArmorDress1', { killed: 'Skeleton_Hildir' }),
  traderRecipe(350, 'ArmorDress4', { killed: 'Skeleton_Hildir' }),
  traderRecipe(350, 'ArmorDress7', { killed: 'Skeleton_Hildir' }),
  traderRecipe(350, 'ArmorTunic1', { killed: 'Skeleton_Hildir' }),
  traderRecipe(350, 'ArmorTunic4', { killed: 'Skeleton_Hildir' }),
  traderRecipe(350, 'ArmorTunic7', { killed: 'Skeleton_Hildir' }),
  traderRecipe(200, 'HelmetHat1', { killed: 'Skeleton_Hildir' }),
  traderRecipe(250, 'HelmetHat2', { killed: 'Fenring_Cultist_Hildir' }),
  traderRecipe(200, 'HelmetHat3', { killed: 'Skeleton_Hildir' }),
  traderRecipe(250, 'HelmetHat4', { killed: 'Fenring_Cultist_Hildir' }),
  traderRecipe(150, 'HelmetHat5'),
  traderRecipe(250, 'HelmetHat6', { killed: 'Fenring_Cultist_Hildir' }),
  traderRecipe(300, 'HelmetHat7', { killed: 'GoblinBruteBros' }),
  traderRecipe(300, 'HelmetHat8', { killed: 'GoblinBruteBros' }),
  traderRecipe(300, 'HelmetHat9', { killed: 'GoblinBruteBros' }),
  traderRecipe(150, 'HelmetHat10'),
  traderRecipe(50, 'FireworksRocket_White', { killed: 'GoblinBruteBros' }),
  traderRecipe(150, 'Sparkler'),
  traderRecipe(75, 'Ironpit'),
  traderRecipe(600, 'BarberKit'),
