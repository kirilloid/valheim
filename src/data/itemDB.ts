...
export const extraData: Record<string, GameComponent[]> = {
  ...
  DG_NorthVillage: ['DungeonGenerator'],
  ...
  FirTree_big_Sapling: ['Plant'],

  TrophyDraugrFem: ['ItemDrop'],

  Spawner_Bat: ['CreatureSpawner'],
  Spawner_Bjorn_sleeping: ['CreatureSpawner'],
  Spawner_Blob: ['CreatureSpawner'],
  Spawner_BlobElite: ['CreatureSpawner'],
  Spawner_BlobTar: ['CreatureSpawner'],
  Spawner_BlobTar_respawn_30: ['CreatureSpawner'],
  Spawner_Boar: ['CreatureSpawner'],
  Spawner_Charred: ['CreatureSpawner'],
  Spawner_Charred_Archer: ['CreatureSpawner'],
  Spawner_Charred_balista: ['CreatureSpawner'],
  Spawner_Charred_Dyrnwyn: ['CreatureSpawner'],
  Spawner_Charred_Mage: ['CreatureSpawner'],
  Spawner_Cultist: ['CreatureSpawner'],
  Spawner_Cultist_Hildir: ['CreatureSpawner'],
  Spawner_Cultist_Hildir_bossroom: ['CreatureSpawner'],
  Spawner_Draugr: ['CreatureSpawner'],
  Spawner_Draugr_Elite: ['CreatureSpawner'],
  Spawner_Draugr_Ranged: ['CreatureSpawner'],
  Spawner_DvergerArbalest: ['CreatureSpawner'],
  Spawner_DvergerAshlands: ['CreatureSpawner'],
  Spawner_DvergerDeepNorth: ['CreatureSpawner'],
  Spawner_DvergerMage: ['CreatureSpawner'],
  Spawner_DvergerRandom: ['CreatureSpawner'],
  Spawner_ElakingMole_Wakeup: ['CreatureSpawner'],
  Spawner_FallenValkyrie: ['CreatureSpawner'],
  Spawner_Fenring: ['CreatureSpawner'],
  Spawner_Fish4: ['CreatureSpawner'],
  Spawner_Frysling: ['CreatureSpawner'],
  Spawner_Frysling_respawn_30: ['CreatureSpawner'],
  Spawner_Ghost: ['CreatureSpawner'],
  Spawner_Ghost_sleeping: ['CreatureSpawner'],
  Spawner_Ghost_Void: ['CreatureSpawner'],
  Spawner_Goblin: ['CreatureSpawner'],
  Spawner_GoblinArcher: ['CreatureSpawner'],
  Spawner_GoblinBrute: ['CreatureSpawner'],
  Spawner_GoblinBrute_Hildir: ['CreatureSpawner'],
  Spawner_GoblinDeepNorth: ['CreatureSpawner'],
  ...
  Spawner_JotunDualWield: ['CreatureSpawner'],
  Spawner_JotunWarrior: ['CreatureSpawner'],
  Spawner_JotunWitch: ['CreatureSpawner'],
  Spawner_Kvastur: ['CreatureSpawner'],
  Spawner_Morgen: ['CreatureSpawner'],
  Spawner_Morgen_wakeup: ['CreatureSpawner'],
  ...
  Spawner_Tick: ['CreatureSpawner'],
  Spawner_Twitcher: ['CreatureSpawner'],
  Spawner_Ulv: ['CreatureSpawner'],
  Spawner_Volture: ['CreatureSpawner'],
  Spawner_Wraith: ['CreatureSpawner'],
  Spawner_Writhan: ['CreatureSpawner'],
