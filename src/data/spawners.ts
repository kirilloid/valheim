...
export const spawners: Spawner[] = [
  {
    type: 'spawner',
    tier: 4,
    id: 'Spawner_Skeleton_Meadows_night_noarcher',
    spawn: 'Skeleton_Meadows_noarcher',
    night: true,
    levels: [1, 1],
    levelUpChance: 0.1,
  },
  ...
  },
  {
    type: 'spawner',
    tier: 8,
    id: 'Spawner_JotunDualWield',
    spawn: 'JotunWarriorDualWield',
    levels: [1, 3],
    levelUpChance: 0.1,
  },
  {
