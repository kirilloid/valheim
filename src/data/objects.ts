...
export function fullDestructible(obj: PhysicalObject | undefined): PhysicalObject | undefined {
  ...
  const result: PhysicalObject & {
    ...
    type: 'object',
    subtype: obj.subtype,
    Destructible: { ...obj.Destructible, parts: [] },
    drop: obj.drop ?? [],
  };
  ...
  },
  {
    ...
    drop: [{
      ...
      options: [
        ...
        { item: 'MeadPoisonResist', num: [1, 2] },
        { item: 'Sausages', num: [3, 6] },
...
export const objects: PhysicalObject[] = [
  ...
  },
  {
    type: 'object',
    subtype: 'plant',
    id: 'Pickable_Mushroom_SmokePuff',
    components: ['Pickable', 'Plant'],
    tier: 6,
    Plant: {
      subtype: 'shroom',
      plantedWith: 'MushroomSmokePuff',
      growTime: [4000, 5000],
      cultivatedGround: true,
      destroyUnhealthy: true,
      freeSpaceRadius: 0.8,
    ...
    // PointLight: { color: '#66CDFF', range: 5, intensity: 1.5 },
    drop: [singleDrop('MushroomSmokePuff', 3)],
  },
  {
    type: 'object',
    subtype: 'indestructible',
  ...
  },
  {
    ...
    disabled: true, // currently catapult ammo encodes damage effect directly
    iconId: 'weapon/BombSiege',
    tier: 7,
    Aoe: {
      damage: dmg({ /*damage: 100, */pickaxe: 400, chop: 100 }),
      backstabBonus: 1,
      radius: 3,
      ttl: 0,
    },
