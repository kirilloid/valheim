...
export const pieces: Piece[] = [
  ...
  },
  {
    ...
    subtype: 'structure',
    tier: 2,
    piece: { target: 'random', water: undefined, size: [2, 0.5, 1] },
  ...
  stoneStructure('stone_wall_4x2', [4, 1, 2], 6),
  stoneStructure('stone_pillar', [1, 1, 2], 5),
  stoneStructure('stone_arch', [2, 1, 1], 4),
  stoneStructure('stone_floor_2x2', [2, 2, 1], 6),
  { ...stoneStructure('stone_floor', [4, 4, 1], 8), disabled: true },
  stoneStructure('stone_stair', [2, 2, 1], 8),
  marbleStructure('blackmarble_1x1', [1, 1, 1], 3),
  marbleStructure('blackmarble_2x1x1', [2, 1, 1], 4),
  // marbleStructure('blackmarble_2x2_enforced', [2, 1, 1], 1, { iconId: 'piece/blackmarble_1x1' }),
  // marbleStructure('blackmarble_2x2x1', [2, 2, 1], 1, { iconId: 'piece/blackmarble_1x1' }),
  marbleStructure('blackmarble_2x2x2', [2, 2, 2], 6),
  marbleStructure('blackmarble_arch', [2, 1, 2], 4),
  ...
  marbleStructure('blackmarble_column_1', [2, 2, 2], 6),
  marbleStructure('blackmarble_column_2', [2, 2, 2], 3),
  // marbleStructure('blackmarble_column_3', [2, 2, 2], 1, { iconId: 'piece/blackmarble_1x1', health: 4000 }),
  ...
  marbleStructure('blackmarble_floor', [2, 2, 1], 6),
  ...
  // marbleStructure('blackmarble_head_big01', [2, 2, 1], 1, { iconId: 'piece/blackmarble_1x1' }),
  // marbleStructure('blackmarble_head_big02', [2, 2, 1], 1, { iconId: 'piece/blackmarble_1x1' }),
  ...
  marbleStructure('blackmarble_outcorner', [2, 2, 1], 6),
  // object: 'blackmarble_post01'
  // marbleStructure('blackmarble_slope_1x2', [2, 2, 1], 1, { iconId: 'piece/blackmarble_1x1' }),
  ...
  marbleStructure('blackmarble_stair', [1, 1, 2], 8),
  marbleStructure('blackmarble_tip', [1, 1, 2], 3),
  {
    id: 'iron_floor_1x1',
    base: false,
    type: 'piece',
  ...
  },
  {
    ...
    tier: 6,
    craft: { },
    piece: { target: 'primary', water: false, onlyOnFlat, size: [0.5, 2, 0.5] },
    wear: wearStructure(100, mods([0, 0, 0, 4, 4, 0, 0, 0, 3, 3]), MaterialType.Wood, { noRoof: false }),
  ...
  },
  {
    ...
    tier: 6,
    emoji: '',
    piece: { target: 'random', water: undefined, size: [0.7, 0.7, 4] },
  ...
  },
  {
    ...
    subtype: 'structure',
    tier: 6,
    piece: { target: 'random', water: undefined, size: [4, 0.7, 4] },
  ...
  },
  {
    ...
    tier: 6,
    emoji: '',
    piece: { target: 'none', water: undefined, size: [2, 2, 2] },
  ...
  },
  {
    ...
    Aoe: { damage: dmg({ pierce: 15 }), self: 34 },
    piece: { target: 'random', water: undefined, size: [2, 1, 2] },
    wear: wearStructure(500, { ...woodResist, frost: 'resistant', lightning: 'resistant' }, MaterialType.HardWood),
  ...
  },
  {
    ...
    tier: 6,
    piece: { target: 'random', water: false, onlyOnFlat, size: [1, 1, 1] },
