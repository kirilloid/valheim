...
const marbleStructure = (
  ...
  tier: 6,
  piece: { target: 'random', water: undefined, size },
  wear: wearStructure(health, resist, MaterialType.Marble, { noRoof: false, ashResist: true, burnable: false }),
  recipe: {
    type: 'craft_piece',
...
export const pieces: Piece[] = [
  ...
  marbleStructure('blackmarble_floor_triangle', [2, 2, 1], 3, { resist: mods([1, 1, 1, 1, 0, 3, 3, 3, 3, 3]) }), // ashResist: false
  marbleStructure('blackmarble_out_1', [2, 2, 1], 5),
  marbleStructure('blackmarble_outcorner', [2, 2, 2], 6),
  marbleStructure('blackmarble_stair', [2, 1, 2], 8, { resist: mods([1, 1, 1, 1, 0, 3, 3, 3, 3, 3]) }),
  ...
  {
    ...ashwoodStructure(
      'piece_stakewall_blackwood', [2, 3, 2], 6,
      { health: 450, resist: { ...ashwoodResist, fire: 'normal', pickaxe: 'normal' } }
    ),
